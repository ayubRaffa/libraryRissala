...
(function () {
  let AjaxMonitor; let Bar; let DocumentMonitor; let ElementMonitor; let ElementTracker; let EventLagMonitor; let Evented; let Events; let NoTargetError; let Pace; let RequestIntercept; let SOURCE_KEYS; let Scaler; let SocketRequestTracker; let XHRRequestTracker; let addEventListener; let animation; let avgAmplitude; let bar; let cancelAnimation; let cancelAnimationFrame; let defaultOptions; let extend; let extendNative; let getFromDOM; let getIntercept; let handlePushState; let ignoreStack; let init; let now; let options; let requestAnimationFrame; let result; let runAnimation; let scalers; let shouldIgnoreURL; let shouldTrack; let source; let sources; let uniScaler; let _WebSocket; let _XDomainRequest; let _XMLHttpRequest; let _i; let _intercept; let _len; let _pushState; let _ref; let _ref1; let _replaceState;
  const __slice = [].slice;
  ...
  addEventListener = function (obj, event, callback) {
    ...
    return (function () {
      if (typeof obj[`on${event}`] !== 'function' || typeof obj[`on${event}`].eventListeners !== 'object') {
        ...
        var { eventListeners } = obj[`on${event}`];
      }
  ...
  extend = function () {
    let key; let out; let source; let sources; let val; let _i; let
      _len;
  ...
  avgAmplitude = function (arr) {
    let count; let sum; let v; let _i; let
      _len;
    sum = count = 0;
  ...
  Evented = (function () {
    ...
    Evented.prototype.trigger = function () {
      let args; let ctx; let event; let handler; let i; let once; let _ref; let _ref1; let
        _results;
  ...
  Bar = (function () {
    ...
    Bar.prototype.getElement = function () {
      ...
      if (this.el == null) {
        ...
        const _custom_class_name = (options.className !== '') ? ` ${options.className}` : '';
    ...
    Bar.prototype.render = function () {
      let el; let key; let progressStr; let transform; let _j; let _len1; let
        _ref2;
  ...
  Events = (function () {
    ...
    Events.prototype.trigger = function (name, val) {
      let binding; let _j; let _len1; let _ref2; let
        _results;
  ...
  shouldIgnoreURL = function (url) {
    let pattern; let _j; let _len1; let
      _ref2;
  ...
  getIntercept().on('request', function (_arg) {
    let after; let args; let request; let type; let
      url;
    ...
    if (!Pace.running && (options.restartOnRequestAfter !== false || shouldTrack(type) === 'force')) {
      ...
      return setTimeout(() => {
        let stillActive; let _j; let _len1; let _ref2; let _ref3; let
          _results;
        if (type === 'socket') {
  ...
  AjaxMonitor = (function () {
    ...
    AjaxMonitor.prototype.watch = function (_arg) {
      let request; let tracker; let type; let
        url;
      type = _arg.type, request = _arg.request, url = _arg.url;
      if (shouldIgnoreURL(url)) {
        return;
    ...
    AjaxMonitor.prototype.complete = function (tracker) {
      return this.elements = this.elements.filter((e) => e !== tracker);
    };
  ...
  ElementMonitor = (function () {
    function ElementMonitor(options) {
      let selector; let _j; let _len1; let
        _ref2;
      if (options == null) {
        options = {};
      }
  ...
  Scaler = (function () {
    ...
    Scaler.prototype.tick = function (frameTime, val) {
      ...
      scaling = 1 - (this.progress / 100) ** options.easeFactor;
  ...
  (init = function () {
    let type; let _j; let _k; let _len1; let _len2; let _ref2; let _ref3; let
      _ref4;
  ...
  Pace.go = function () {
    ...
    return animation = runAnimation((frameTime, enqueueNextFrame) => {
      let avg; let count; let done; let element; let elements; let i; let j; let remaining; let scaler; let scalerList; let sum; let _j; let _k; let _len1; let _len2; let
        _ref2;
